import { MedicineListProps, LabProps, ManufacturerProps } from '../@types'
...
export const medicines: MedicineListProps[] = [
  {
  ...
  },
  {
    ...
    scientificName:
      'Sodium chloride , Potassium chloride , Tri sodium citrate anhydrous , Dextrose Anhydrous',
